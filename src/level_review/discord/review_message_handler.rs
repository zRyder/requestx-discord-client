use log::error;
use serenity::all::{Color, Context, CreateEmbed, CreateMessage, EditMessage, GenericChannelId, GuildId, Mentionable, Message, MessageBuilder, MessageId, RoleId, User, UserId};
...
pub async fn post_level_review(
    ctx: &Context,
